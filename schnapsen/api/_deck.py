...
class Deck:
    ...
    def __init__(self,
        ...
        self.__trump_suit = trump_suit if trump_suit is not None else self.get_suit(
            self.__stock[0])
    ...
    def exchange_trump(self, trump_jack_index):
        ...
        self.__card_state[trump_card_index] = self.__p1_perspective[
            trump_card_index] = self.__p2_perspective[trump_card_index] = self.__card_state[trump_jack_index]
    ...
    def put_trick_away(self, winner):
        self.__card_state[self.__trick[0]] = self.__card_state[self.__trick[1]] = self.__p1_perspective[self.__trick[0]] = self.__p1_perspective[self.__trick[1]
                                                                                                                                                 ] = self.__p2_perspective[self.__trick[0]] = self.__p2_perspective[self.__trick[1]] = "P1W" if winner == 1 else "P2W"
    ...
    def generate(id=None):
        ...
        p1_perspective[shuffled_cards[0]
                       ] = p2_perspective[shuffled_cards[0]] = "S"
    ...
    def make_assumption(self, seed=None):
        ...
        unknowns = [index for index, card in enumerate(
            perspective) if card == "U"]
        ...
        deck = Deck(perspective, stock, list(
            self.__p1_perspective), list(self.__p2_perspective))
    ...
    def clone(self, signature):
        deck = Deck(list(self.__card_state), list(self.__stock), list(
            self.__p1_perspective), list(self.__p2_perspective), self.__trump_suit)
    ...
    def load_from_json(dict):
        deck = Deck(dict['card_state'], dict['stock'],
                    dict['p1_perspective'], dict['p2_perspective'])
